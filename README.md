...
Phase 2 started: Scenario Design and Dataset Creation.
...
Create a controlled, labeled, MITRE-mapped Wazuh alert dataset across attack-like, benign, noisy, and false-positive scenarios. The dataset will support later alert normalization, clustering, context enrichment, MITRE mapping, LLM hypothesis evaluation, graph validation, and policy-safe response evaluation.
